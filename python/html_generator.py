...
<head>
    ...
    <meta name="keywords" content="{category.lower()}, {title.lower()}, trends, news">
    ...
    <meta property="og:image" content="https://omnitrends.github.io/images/{slug}.jpg">
    ...
    <meta property="twitter:image" content="https://omnitrends.github.io/images/{slug}.jpg">
    ...
    {{
        ...
        "headline": "{title}",
        "description": "{excerpt}",
        "image": "https://omnitrends.github.io/images/{slug}.jpg",
        "author": {{
            "@type": "Organization",
            "name": "OmniTrends"
        }},
        ...
        <div class="container">
            <article class="article">
                <div class="article__image">
                    <img src="../images/{slug}.jpg" alt="{title}" loading="lazy">
                </div>
...
def move_image(slug):
    ...
    if os.path.exists(temp_image_path):
        ...
        print(f"Image moved to: {target_image_path}")
        return True
    else:
